...
namespace Generic.Steps.Trx
{
	...
	[XmlRoot(ElementName="TestCategoryItem", Namespace="http://microsoft.com/schemas/VisualStudio/TeamTest/2010")]
	public class TestCategoryItem {
		[XmlAttribute(AttributeName="TestCategory")]
		public string? TestCategory { get; set; }
	}

	[XmlRoot(ElementName="TestCategory", Namespace="http://microsoft.com/schemas/VisualStudio/TeamTest/2010")]
	public class TestCategory {
		[XmlElement(ElementName="TestCategoryItem", Namespace="http://microsoft.com/schemas/VisualStudio/TeamTest/2010")]
		public List<TestCategoryItem>? TestCategoryItem { get; set; }
	}
	...
	public class UnitTest {
		[XmlElement(ElementName="TestCategory", Namespace="http://microsoft.com/schemas/VisualStudio/TeamTest/2010")]
    ...
    public class TrxXMLProcedures
    {
        public static TestRun? MakeTrxMode<TestRun>(string xml)
        {
            var xmlserializer = new XmlSerializer(typeof(TestRun));  
            var stringReader = new StringReader(xml);  
            using (var reader = XmlReader.Create(stringReader))  
            {  
                return (TestRun?)xmlserializer.Deserialize(reader);  
            }  
        }
